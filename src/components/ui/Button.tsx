...
export default function Button({ 
  ...
  const baseClasses = 'inline-flex items-center justify-center font-medium transition-colors gap-1';
  ...
  const variantClasses = {
    ...
    secondary: {
      normal: 'bg-gray-0 text-gray-600 border border-gray-300 shadow-[0px_4px_8px_0px_rgba(24,24,24,0.05)] text-body2 font-medium',
