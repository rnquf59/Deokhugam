...
const dummyReviews: PopularReview[] = [
  {
    ...
    userNickname: "독서왕",
    reviewContent:
      "이 책은 올리버라는 한 남자의 복잡한 내면을 섬세하게 그려내고 있습니다. 모든 문장이 시처럼 아름답고, 읽는 내내 깊은 위로를 받았습니다. 잔잔하게 마음을 울리는 소설을 찾는 분들께 꼭 추천하고 싶은 작품입니다.",
    reviewRating: 4.5,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "책벌레",
    reviewContent:
      "일상의 소소한 행복을 찾는 방법에 대해 이야기하는 책입니다. 바쁜 현대인들에게 잠시나마 마음의 여유를 선사해주는 따뜻한 메시지가 담겨있어요.",
    reviewRating: 4.0,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "시간여행자",
    reviewContent:
      "시간에 대한 철학적 사고를 담은 작품으로, 읽는 동안 많은 생각을 하게 만듭니다. 작가의 깊이 있는 통찰력이 돋보이는 책입니다.",
    reviewRating: 5.0,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "꿈분석가",
    reviewContent:
      "꿈에 대한 심리학적 접근이 흥미로운 책입니다. 자신의 꿈을 이해하는 새로운 관점을 제시해주어서 읽어볼 만합니다.",
    reviewRating: 3.5,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "바다사랑",
    reviewContent:
      "바다를 소재로 한 아름다운 이야기입니다. 바닷가에서의 추억과 감정이 생생하게 전달되어 마치 바다에 있는 것 같은 느낌을 받았습니다.",
    reviewRating: 4.2,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "자연인",
    reviewContent:
      "자연과 인간의 관계에 대해 생각해보게 하는 책입니다. 숲의 신비로움과 자연의 소중함을 일깨워주는 좋은 작품이에요.",
    reviewRating: 4.8,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "별관찰자",
    reviewContent:
      "밤하늘의 별들을 소재로 한 감성적인 이야기입니다. 어둠 속에서도 빛을 잃지 않는 희망의 메시지가 담겨있어요.",
    reviewRating: 4.3,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "나비추종자",
    reviewContent:
      "자유롭게 춤추는 나비의 모습을 통해 삶의 자유로움을 표현한 아름다운 작품입니다. 가벼우면서도 깊이 있는 메시지가 인상적이에요.",
    reviewRating: 4.6,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "비사랑",
    reviewContent:
      "비 오는 날의 특별한 분위기를 잘 담아낸 작품입니다. 우울하면서도 아름다운 감정이 잘 표현되어 있어서 마음에 와닿았습니다.",
    reviewRating: 4.1,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "바람청취자",
    reviewContent:
      "바람의 소리를 통해 자연의 신비로움을 느낄 수 있는 책입니다. 조용한 시간을 보내고 싶을 때 읽기 좋은 작품이에요.",
    reviewRating: 4.4,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "봄사랑",
    reviewContent:
      "봄의 생명력과 희망을 담은 따뜻한 이야기입니다. 새로운 시작에 대한 용기를 얻을 수 있는 좋은 책이에요.",
    reviewRating: 4.7,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "달빛추종자",
    reviewContent:
      "달빛의 신비로움과 아름다움을 표현한 감성적인 작품입니다. 밤의 정적 속에서 느끼는 특별한 감정이 잘 전달되어요.",
    reviewRating: 4.0,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "새벽기도자",
    reviewContent:
      "새벽의 고요함과 평화로움을 담은 영적인 작품입니다. 마음의 평안을 찾고 싶을 때 읽으면 좋을 것 같아요.",
    reviewRating: 4.5,
    period: "MONTHLY",
  ...
  },
  {
    ...
    userNickname: "등산가",
    reviewContent:
      "산 정상에서 바라본 풍경과 그때의 감정을 생생하게 담아낸 작품입니다. 도전과 성취의 기쁨이 잘 표현되어 있어요.",
    reviewRating: 4.2,
    period: "MONTHLY",
