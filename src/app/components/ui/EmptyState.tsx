...
export default function EmptyState({ title, description, iconSrc, iconAlt }: EmptyStateProps) {
  return (
    <div>
      <h2 className="text-header1 font-bold text-gray-950 mb-[30px] text-center">
        {title}
      </h2>
